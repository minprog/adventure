...
> Het is een grote opdracht, maar zorg wel dat je 'm niet samen gaat doen. Je krijgt er punten voor dus we moeten er wel voor zorgen dat het jouw punten zijn.
...
Download the starter code along with a few versions of the game data:
    ...
    $ cd ~/problems
    $ curl -LO https://github.com/minprog/adventure/raw/2020/steps/adventure.zip
    $ unzip adventure.zip
    $ rm adventure.zip
    $ cd adventure
    $ ls
